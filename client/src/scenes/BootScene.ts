...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    const turretBarrels = {
      'turret_barrel_standard': { frameWidth: 72, frameHeight: 72 },
      'turret_barrel_spread': { frameWidth: 72, frameHeight: 72 },
      'turret_barrel_lightning': { frameWidth: 72, frameHeight: 72 },
    };
